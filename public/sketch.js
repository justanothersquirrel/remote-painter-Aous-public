...
// Create some variables for our color selector functionality
let r = 255;
let g = 0;
let b = 0;
...
function setup() {
  ...
  //creating three sliders for colour selection
  ...
  //all slider's changes call the same callback function
